...
const zh: Record<string, string> = {
  ...
  'Fifth proposal this quest: if this crew is rejected, Evil wins.': '本轮第 5 次组队：这支队伍如果再被否决，坏人直接获胜。',
  'Evil wins because five crew proposals in a row were rejected this quest.': '本轮连续 5 次组队被否决，坏人获胜。',
  'Five proposals rejected': '连续 5 次组队被否决',
  ...
  'Join a room': '加入房间',
  'Host a table or join one': '开一桌，还是加入一桌？',
  "I'm the host. Get a room code for the table.": '我来当房主，生成房号给大家',
  'I have a 5-digit room code.': '我有 5 位房号',
  ...
  'Close': '关闭',
  'Close result summary': '关闭结算',
  'Who was who': '身份揭晓',
  'Every player\'s secret role this game.': '本局每位玩家的真实身份。',
  'Final role reveal': '全员身份揭晓',
  'You': '你',
  ...
  'Could not swap seats.': '无法交换座位。',
  'Seats can only be arranged between games.': '座位只能在两局之间调整。',
  'Only the host can arrange seats.': '只有房主可以调整座位。',
  'Round table': '圆桌座位',
  'Seats unlocked': '可调整座位',
  'Seats locked': '座位已锁定',
  'Open seat': '空位',
  'Tap two players to swap their seats.': '点两个人，互换座位',
  'Now tap the player to swap with.': '再点一个人，完成互换',
  'Seats in table order': '按座位顺序排列的玩家',
  'Confirm seats and ready': '确认座位并准备',
  'Waiting for the host to confirm seats': '等待房主确认座位',
  'The host checks the round table matches where everyone sits, then taps ready.': '房主核对圆桌与实际座位一致后，点准备即可开局。',
  'If anyone changed seats, swap them on the round table before playing again.': '如果有人换了座位，先在圆桌上调整，再点再来一局。',
  'If anyone changed seats, close this and swap them on the round table first.': '如果有人换了座位，先关闭此窗口，在圆桌上调整好。',
  'Abandon Game': '作废本局',
